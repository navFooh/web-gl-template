require.config({
	...
	paths: {
		...
		'three-lib':            'vendor/three/build/three',
		'three-gltf-loader':    'vendor/three/examples/js/loaders/GLTFLoader',
		'three-projector':      'vendor/three/examples/js/renderers/Projector',
